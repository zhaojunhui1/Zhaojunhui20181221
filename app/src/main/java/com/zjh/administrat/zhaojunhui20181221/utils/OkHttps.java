package com.zjh.administrat.zhaojunhui20181221.utils;
...
public class OkHttps {
    ...
    public void postRequest(final String urlStr, Map<String, String> params, final Class clazz, final ICallBack iCallBack){
